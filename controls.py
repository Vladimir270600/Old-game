...
def events(screen, gun, bullets):
    ...
    for event in pygame.event.get():
            if event.type == pygame.QUIT:
                ...
                # Движение пушки по горизонтали вправо.
                ...
                if event.key == pygame.K_d:
                      # Eсли убираем палец с клавиши, то перемещение прекращаеться.
                      gun.mright = False
                elif event.key == pygame.K_a:
                      gun.mleft = False
...
def update(bg_color, screen, stats, sc, gun, inos, bullets):
        ...
        sc.show_score()
        # Выводим пули из дула пушки.
        for bullet in bullets.sprites():
              bullet.draw_bullet()
        # Вызываем функцию отрисовки пушки.
        gun.output()
        # Отрисовываем прищельцев.
        inos.draw(screen)
